...
def title_duration_prompter():
  '''function that prompts all movie titles and durations '''
  for movie in DATA['latest_from_star_wars']:
    print(f'{movie["title"]} ({movie["length"]})')


def main():
  title_duration_prompter()
